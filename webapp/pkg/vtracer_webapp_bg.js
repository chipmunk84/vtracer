...
const BinaryImageConverterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_binaryimageconverter_free(ptr >>> 0));
/**
*/
...
const ColorImageConverterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_colorimageconverter_free(ptr >>> 0));
/**
*/
...
export function __wbg_prepend_6fcfb183e9fe632c() { return handleError(function (arg0, arg1) {
